                        ...
                        <div className={'flex items-center'}>
                            <span
                                className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                                    isSuspended ? 'bg-red-500/20 text-red-400' : 'bg-neutral-500/20 text-neutral-400'
                                }`}
                            >
                        ...
                        <>
                            <div className={'flex flex-col items-center min-w-[70px]'}>
                                <div className={'flex items-center gap-1.5'}>
                                    <FontAwesomeIcon
                                        icon={faMicrochip}
                                        className={`text-xs ${alarms.cpu ? 'text-red-400' : 'text-neutral-500'}`}
                                    />
                            ...
                            <div className={'flex flex-col items-center min-w-[70px]'}>
                                <div className={'flex items-center gap-1.5'}>
                                    <FontAwesomeIcon
                                        icon={faMemory}
                                        className={`text-xs ${alarms.memory ? 'text-red-400' : 'text-neutral-500'}`}
                                    />
                                    <p className={'text-sm font-semibold text-neutral-200'}>
